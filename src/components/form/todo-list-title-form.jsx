    ...
    return (
        <div className="min-h-[70vh] flex flex-col items-center justify-center gap-4">
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full">
                <input onChange={handleChange} className="shadow-md p-4 rounded-sm w-1/3 mx-auto" value={listName} type="text" name="list-name" required placeholder="Enter a To-Do List Title" />
